						...
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_filter_popup_result right" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
									...
									<a rel="nofollow" href="<?echo str_replace('/filter/clear/apply/', '/', $arResult["FILTER_URL"]);?>" class="button white_bg"><?echo Loc::getMessage("CT_BCSF_FILTER_SHOW")?></a>
								</div>
								<input class="bx_filter_search_button button small" type="submit" id="set_filter" name="set_filter" data-href="" value="<?=Loc::getMessage("CT_BCSF_SET_FILTER")?>" />
