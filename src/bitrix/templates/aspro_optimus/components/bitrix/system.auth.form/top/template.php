...
<?else:?>
	<div class="module-enter have-user">
		...
		<!--noindex-->
			...
			<a href="<?=SITE_DIR?>?logout=yes<?= COption::GetOptionString('main', 'secure_logout') === 'Y' ? '&sessid='.bitrix_sessid() : null; ?>" class="exit_link" rel="nofollow"><span><?=GetMessage("AUTH_LOGOUT_BUTTON");?></span></a>
		<!--/noindex-->
	</div>	
<?endif;?>
<?$frame->end();?>
