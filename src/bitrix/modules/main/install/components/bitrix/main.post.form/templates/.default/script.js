...
this.BX = this.BX || {};
(function (exports,main_core_events,main_polyfill_intersectionobserver,main_popup,main_core,ai_copilot) {
	'use strict';
	...
	* */
	...
	var Editor = /*#__PURE__*/function () {
	  function Editor(options, editorParams) {
	    ...
	    babelHelpers.defineProperty(this, "aiResultNodeAttr", 'bxhtmled-copilot-result-node');
	    babelHelpers.defineProperty(this, "aiResultColor", '#8d52ec');
	  ...
	  babelHelpers.createClass(Editor, [{
	    ...
	    value: function showCopilot() {
	      var _BX$AI;
	      if (!((_BX$AI = BX.AI) !== null && _BX$AI !== void 0 && _BX$AI.Copilot)) {
	        return;
	      }
	      if (!this.copilot) {
	        this.initCopilot();
	      ...
	      this.emptyLine = BX.Tag.render(_templateObject$3 || (_templateObject$3 = babelHelpers.taggedTemplateLiteral(["<div></div>"])));
	    ...
	    key: "getBindPosition",
	    value: function getBindPosition() {
	      return {
	    ...
	    key: "getResultNodes",
	    value: function getResultNodes() {
	      return babelHelpers.toConsumableArray(this.contentEditable.querySelectorAll("[".concat(this.aiResultNodeAttr, "=true]")));
	    }
	  }, {
	    key: "aiResultHandler",
	    value: function aiResultHandler(event) {
	      var resultNodes = this.getResultNodes();
	      var lastResultSpan = null;
	    ...
	    value: function saveHandler(event) {
	      if (this.emptyLine && main_core.Type.isDomNode(this.emptyLine)) {
	        main_core.Dom.remove(this.emptyLine);
	      }
	      if (this.getResultNodes().length === 0) {
	        var selection = this.htmlEditor.iframeView.GetSelection().getRangeAt(0);
	        var span = this.getSpanWithText(event.data.result);
	        selection.deleteContents();
	        selection.insertNode(span);
	        this.htmlEditor.iframeView.UpdateHeight();
	      }
	      var _iterator = _createForOfIteratorHelper(this.getResultNodes()),
	        _step;
	      try {
	        for (_iterator.s(); !(_step = _iterator.n()).done;) {
	          var resultNode = _step.value;
	          var _iterator2 = _createForOfIteratorHelper(resultNode.childNodes),
	            _step2;
	          try {
	    ...
	    value: function removeResult() {
	      ...
	      this.getResultNodes().forEach(function (resultNode) {
	        return resultNode.remove();
	      });
	    }
	  }, {
	    ...
	    key: "onWindowKeyDownHandler",
	    value: function onWindowKeyDownHandler(event) {
	      if (event.key === 'Escape') {
	        this.copilot.hide();
	      }
	    }
...
}((this.BX.Main = this.BX.Main || {}),BX.Event,BX,BX.Main,BX,BX.AI));
