...
$MESS["CP_BCS_OFFER_TREE_PROPS"] = "Свойства для отбора торговых предложений";
...
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_OFFERS"] = "Не отображать торговые предложения, которых нет на складах";
