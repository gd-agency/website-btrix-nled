...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_FEEDBACK", "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("shopEmail"), "EMAIL_TO" => $wizard->GetVar("shopEmail"), "SUBJECT" => GetMessage("NEW_FEEDBACK_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_FEEDBACK_EMAIL_TEXT"), "BODY_TYPE" => "html");
