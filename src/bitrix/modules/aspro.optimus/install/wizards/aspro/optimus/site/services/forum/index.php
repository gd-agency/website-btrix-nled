...
$arForums = Array(
	Array(
		"XML_ID" => "OPTIMUS_REVIEWS",
		"NAME" => GetMessage("OPTIMUS_REVIEWS_FORUM_NAME"),
		"DESCRIPTION" => GetMessage("OPTIMUS_REVIEWS_FORUM_DESCRIPTION"),
		"SORT" => 2,
		"ACTIVE" => "Y",
		"ALLOW_HTML" => "N",
		"ALLOW_ANCHOR" => "Y",
...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "XML_ID" => "OPTIMUS_REVIEWS"));
if ($arRes = $dbRes->Fetch())$reviewsForumID = $arRes["ID"];
