...
$MESS['INSTAGRAM_RKN_NOTE_TEXT'] = '* Instagram is recognized as an extremist organization and is prohibited in the Russian Federation';
...
$MESS["EXPRESSION_FOR_CALCULATE_DELIVERY_TITLE_SECTION"] = "Расcчет доставки";
...
$MESS['SHOW_OFFER_TITLE'] = "Your netshop works under public offer?";
$MESS['OFFER_CHECKED_TITLE'] = "Checkbox for agreements with public offer are checked?";
$MESS['OFFER_TEXT_TITLE'] = "Signature to the notification of the offer ";
$MESS['OFFER_NOTE'] = "By default, the file with the public offer is located in the include folder. Do not forget to change the text taking into account the data of your company in the file \"offer_detail.php\"
At your discretion, you can move the file to a different folder. In this case, do not forget to correct the link to the file in the notification signature settings.";

$MESS['T_HEAD_FIXED_CHECK'] = "Display a fixed head";
$MESS['T_HEAD_MOBILE_CHECK'] = "Display mobile fixed head";

$MESS['T_MAP_TYPE'] = "Map type";

$MESS['T_VIEW_TYPE_HIGHLOAD_PROP'] = "Display the value of the \"List\" property when picture is not found";

$MESS['T_CATALOG_PAGE_SECTIONS_TITLE'] = "Catalog sections list template";
$MESS['T_CATALOG_PAGE_SECTIONS_1'] = "List";
$MESS['T_CATALOG_PAGE_SECTIONS_2'] = "Tile";

$MESS['T_CATALOG_PAGE_SUBSECTIONS_TITLE'] = "Catalog subsection list Template";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_1'] = "List";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_2'] = "Tile";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_3'] = "Compact";
?>
