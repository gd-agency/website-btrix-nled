<?
	...
	$bDiscountColumn = (\Bitrix\Main\Config\Option::get('aspro.optimus', 'BASKET_ECONOMY', 'N') == 'Y');
?>
								...
								<td class="count-cell" style="vertical-align: top !important; padding-left: 2px; padding-right: 2px;">
									<div class="counter_block basket">
										...
										<?if($arItem["MEASURE_NAME"]):?>
											<div class="measure"><?=$arItem["MEASURE_NAME"]?></div>
										<?endif;?>
									</div>
							...
							<?elseif ($arHeader["id"] == "PRICE"):?>
								<td class="cost-cell <?=( $bTypeColumn ? 'notes' : '' );?>">
									<div class="cost prices clearfix">
										...
										<?endif;?>
										<?if($arItem["PRICE"] > 0 && doubleval($arItem["DISCOUNT_PRICE_PERCENT"]) > 0 && $bDiscountColumn ){?>
