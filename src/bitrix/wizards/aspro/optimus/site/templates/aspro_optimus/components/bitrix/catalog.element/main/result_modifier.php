...
if(isset($arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']) && is_array($arResult['PROPERTIES']['CML2_ARTICLE']['VALUE']) && is_array($arResult['DISPLAY_PROPERTIES']['CML2_ARTICLE']['VALUE']))
{
