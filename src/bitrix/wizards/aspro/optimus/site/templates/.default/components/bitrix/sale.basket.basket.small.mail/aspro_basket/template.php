...
// echo "<pre>"; print_R($arResult); echo "</pre>";
	...
	if($arResult["ITEMS"]["AnDelCanBuy"] || $arResult["ITEMS"]["DelDelCanBuy"] || $arResult["ITEMS"]["nAnCanBuy"] || $arResult["ITEMS"]["ProdSubscribe"]):?>
		<div class="wrapper_block" style="padding:0px;overflow: hidden;position: relative;">
			<div style="color:#1d2029;font-size:18px;padding: 22px 0px 18px;font-weight:600;"><?=$title;?></div>
			<div style="border: 1px solid #e7e7e7;border-bottom-width:0px;overflow: auto;-webkit-overflow-scrolling: touch;" class="scroll-x-block">
				<table class="sale_basket_small" style="margin: 0;padding: 0;min-width: 100%;border-collapse: collapse;table-layout:fixed;">
					<thead>
