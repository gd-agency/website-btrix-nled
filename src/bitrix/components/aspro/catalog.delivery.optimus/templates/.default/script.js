if(typeof window.JCCatalogDelivery === 'undefined'){
	...
	window.JCCatalogDelivery.prototype = {
		init: function(){
			this.jsSolutionOptions = typeof window['arOptimusOptions'] === 'object' ? window['arOptimusOptions'] : false;
			...
			if(this.ratio_is_float && typeof this.jsSolutionOptions === 'object'){
				this.ratio = Math.round(this.ratio * arOptimusOptions.JS_ITEM_CLICK.precisionFactor) / arOptimusOptions.JS_ITEM_CLICK.precisionFactor;
			}
