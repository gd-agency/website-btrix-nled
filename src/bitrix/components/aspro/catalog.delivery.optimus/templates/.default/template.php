...
<div id="catalog-delivery-<?=$arResult['RAND']?>" class="catalog-delivery form <?=($bCanSearch ? 'cansearch' : '')?> <?=($arResult['ERROR'] ? 'haserror' : '')?> <?=($bNeedSearch ? 'search' : '')?>" style="height:0;overflow: hidden;">
	<div class="catalog-delivery-title">
		<h2><?=str_replace(
			array('#LOCATION_NAME#'),
			array($arResult['LOCATION'] && $arResult['LOCATION']['ID'] ? '<span class="catalog-delivery-title-city"><span>'.$arResult['LOCATION']['LOCATION_NAME'].'</span><span>'.COptimus::showIconSvg([
				'CLASS' => 'down colored_theme_hover_bg-el',
				'PATH' => $this->{'__folder'}.'/images/svg/trianglearrow_down.svg',
				]).'</span></span>' : ''),
	...
	<div class="catalog-delivery-error">
		<div class="catalog-delivery-error-icon"><?=\COptimus::showIconSvg([
			'CLASS' => 'fail colored',
			'PATH' => $this->{'__folder'}.'/images/svg/fail.svg'
		])?>
		</div>
			...
			<div class="catalog-delivery-fields <?=($bEmptyFieldsBlock ? 'empty' : '')?>">
				...
				<?if(!$bEmptyFieldsBlock):?>
					<div class="catalog-delivery-fields-opener">
						<span><?=COptimus::showIconSvg([
							'CLASS' => 'icon',
							'PATH' => $this->{'__folder'}.'/images/svg/filter.svg'
							])?>
						</span>
								...
								<div class="catalog-delivery-field-input" data-item="<?=$arResult['PRODUCT_ID']?>">
									<div class="catalog-delivery-field-box">
										<div class="catalog-delivery-field-box-value">
											<span class="minus dark-color"><?=\COptimus::showIconSvg([
												'', 
												'PATH' => $this->{'__folder'}.'/images/svg/minus.svg'
												])?>
											</span>
											...
											<span class="plus dark-color"><?=\COptimus::showIconSvg([
												'',
												'PATH' => $this->{'__folder'}.'/images/svg/plus.svg'
												])?>
											</span>
										</div>
									</div>
							...
							<div class="catalog-delivery-field catalog-delivery-field_persontype">
								...
								<div class="catalog-delivery-field-input">
									<div class="catalog-delivery-field-box hasdropdown">
										...
										<div class="catalog-delivery-field-box-value" title="<?=$name?>"><span><?=$name?></span><?=COptimus::showIconSvg([
												'CLASS' =>'down colored_theme_hover_bg-el',
												'PATH' => $this->{'__folder'}.'/images/svg/trianglearrow_down.svg',
												'',
												'',
										...
										<div class="catalog-delivery-field-box-dropdown scrollbar">
											<?if($arResult['PERSON_TYPE']):?>
												<?foreach($arResult['PERSON_TYPE'] as $arPersonType):?>
