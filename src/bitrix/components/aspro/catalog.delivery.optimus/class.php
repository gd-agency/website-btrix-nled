...
use COptimusCache as Cache;
//use CNextRegionality as Regionality;

if(!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true) die();
Loc::loadMessages(__FILE__);

class CAsproCatalogDeliveryMarket extends CBitrixComponent{
	const MODULE_ID = 'aspro.optimus';
	...
	public function onPrepareComponentParams($arParams){
		...
		$signedParams = $signer->sign(base64_encode(serialize($arParams)), 'catalog.delivery.optimus');
	...
	protected function initProduct(){
		...
		$bIblockVersion18_6_200 = COptimus::checkVersionModule('18.6.200', 'iblock');
